...
namespace PentominosSharp
{
	...
	public class frmPentominos : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPentominos));
            ...
            this.menuItem3.Text = "Правила игры";
            ...
            this.TimerElapsed.Interval = 800;
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
			...
			// Draw the grid
			grPaint.DrawString("Нажатие левой клавиши - взять и отпустить фигуру", new Font("Arial",12), new SolidBrush(Color.Black),20,10);
			grPaint.DrawString("Нажатие правой клавиши - повернуть ее (при взятой фигуре)", new Font("Arial",12), new SolidBrush(Color.Black),20,30);
		...
		private void frmPentominos_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			...
			if(e.Button == MouseButtons.Left && draggedpiece != null)
			{
				if(draggedpiece != null)
				{
					...
					if(iCount >= 60)
					{
						MessageBox.Show("Congratulations ! Youґve finished !", "Pentominos", MessageBoxButtons.OK, MessageBoxIcon.Information);
		...
		private void TimerElapsed_Tick(object sender, System.EventArgs e)
		{
			...
			String	sTime = String.Format("Прошедшее время: {0:00}:{1:00}:{2:00}", tmElapsed.TotalHours, tmElapsed.Minutes, tmElapsed.Seconds);
